...
public:
    ...
    qint64 getPermanentStakeBalance() const;
...
private:
    ...
    qint64 cachedPermanentStakeBalance;
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance, qint64 permanentStakeBalance);
